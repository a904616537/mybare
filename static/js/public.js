...
var message = {
	zh : {
		error : {
			...
			login          : '登陆失败！',
			login_401      : '你好！',
			login_401_desc : '你的MYbarre教练培训账户暂时不能使用。<br/>请发邮件到info@mybarrefitness.com重新进行激活。<br/>真诚的问候<br/>MYbarre团队',
	...
	en : {
		...
		error : {
			...
			login          : 'Login failed！',
			login_401      : 'Hi!',
			login_401_desc : ' Access to your MYbarre Instructor Account has been temporarily suspended. <br/>Please email us at info@mybarrefitness.com to reactivate this.<br/>Regards <br/>The MYbarre Team',
